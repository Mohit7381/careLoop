...
and `code_gaps[]` that cross team boundaries (Analyst -> Code Scout ->
Reporter -> PRD Generator). Do not change field names here without
syncing with Nakul (Analyst) and Harshit (Code Scout) - the pipeline
validates against these models at each node boundary.

Copied verbatim from "CareLoop - Shared State Contract v2" (2026-09-03).
Do not edit unilaterally - this file is shared team ground truth.
"""
